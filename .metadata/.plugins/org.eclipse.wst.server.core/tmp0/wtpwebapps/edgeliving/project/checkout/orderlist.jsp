<%@page import="vo.JoinOrderMemProdVO"%>
<%@page import="dao.JoinOrderMemProdDAO"%>
...
%>
	...
	<div id="viewcart_contents">
		...
		<div id="viewcart_list">
			...
			<table class="table table-striped table-bordered"	style="width: 1200px; text-align: center">
				...
				<tr style="height: 80px; text-align: center ;" >
					<td style="width: 180px"><%=vo.getOrderno() %></td>
					...
					<td style="width: 100px;font-size: 12px;"><%=df.format(vo.getOrderqty())%></td>
					<td style="width: 170px;font-size: 12px;"><%=df.format(totalprice+2500)%>원</td>
					<td style="width: 100px;font-size: 12px;"><%=strStatus %></td>
					
					<td style="width : 140px;font-size: 12px;">
					<input	type="button" value="구매확정" id="order_finish" /></td>
					<td  style="width : 70px;;font-size: 12px;">
					<a	href="../board/reviewWrite.jsp?orderno=<%=vo.getOrderno()%>">
					<input type="button" value="작성" id="write_review"/></a></td>
		...
		<div id="viewcart_deletebtndiv">
			<div id="viewcart_deletebtndiv1"></div>
			<div id="viewcart_deletebtndiv2">
				<nav aria-label="Page navigation example">
					<ul class="pagination">
						<li class="page-item">
							<a class="page-link" href="orderlist.jsp?cp=1" aria-label="Previous">
			...
			<%
				...
				%> <!-- 누를때마다 커런트페이지가 바뀌도록  --> 
						<li class="page-item"><a class="page-link"	href="orderlist.jsp?cp=<%=i%>"><%=i%></a></li>
				 <%
 			
				}
			%>
					  <li class="page-item">
     					 <a class="page-link" href="orderlist.jsp?cp=<%=endPage %>" aria-label="Next">
			...
			<div id="viewcart_deletebtndiv3"></div>
		</div>
		</form>
